...
.. image:: _static/logos/fdtmlogo.png
  :width: 340
  :height: 370
  :align: right
...
.. container:: centered-intro
  ...
  Dynamical systems provide the foundation for modeling and understanding complex scientific phenomena, from healthcare to climate science and beyond. The growing availability of large-scale time-series data has opened new opportunities for machine learning to model dynamical systems. Time-series foundation models learn transferable representations from observational data and excel at forecasting, while world models learn actioned dynamics that support planning and control. Although these areas are often discussed separately, they share a common goal: learning how a system evolves over time. They also share the same bottleneck in scientific use. Strong predictive performance does not guarantee mechanistic understanding, and it does not guarantee robustness under distribution shift or reliable behavior under intervention and control. 

  A third line of work targets learning underlying mechanisms more directly: system identification, causal modeling, and hybrid mechanistic–data-driven methods provide principled tools for interpretability and for encoding prior knowledge. Their structure can make them easier to validate, but often less flexible for high-dimensional, multi-modal data. As a result, it remains unclear how and to what extent these models can benefit from the performance of time-series foundation models and world models.

  This workshop focuses on data-driven dynamical models for scientific discovery and on bridging the gap between performance and mechanistic validity. Three questions shape the program: (1) *What level of mechanistic understanding in dynamical models is needed for different scientific domains and questions?*; (2) *When can purely data-driven models reliably surface scientific insights about the underlying observed system, and how can we evaluate this?*; (3) *How can we improve mechanistic validity through inductive biases and hybrid designs?* 
...
Submissions will present novel work and reflect the diversity of perspectives that the workshop aims to foster and connect. We invite two complementary types of submissions:
